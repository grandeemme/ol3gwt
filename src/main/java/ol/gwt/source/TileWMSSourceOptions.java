...
public class TileWMSSourceOptions extends JavaScriptObject {
	...
	/**
	 * WMS request parameters. At least a LAYERS param is required. STYLES is '' by default. VERSION is 1.3.0 by
	 * default. WIDTH, HEIGHT, BBOX and CRS (SRS for WMS version &lt; 1.3.0) will be set dynamically.
	 *
	 * @param params
	 */
	public native final void setParams(Params params)/*-{
		this.params = params;
	}-*/;
	 ...
	 * Using a non-zero value allows artifacts of rendering at tile edges to be ignored. If you control the WMS service
	 * it is recommended to address "artifacts at tile edges" issues by properly configuring the WMS service. For
	 * example, MapServer has a tile_map_edge_buffer configuration parameter for this. See
