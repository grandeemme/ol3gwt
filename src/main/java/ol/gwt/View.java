...
import ol.gwt.view.StatusChangeListener;
...
public class View extends JavaScriptObject {
	...
	public native final double getResolutionForExtent(Extent extent, Size size)/*-{
		var xResolution = $wnd.ol.extent.getWidth(extent) / size[0];
		var yResolution = $wnd.ol.extent.getHeight(extent) / size[1];
	...
	public native final JavaScriptObject addStatusChangeListener(StatusChangeListener listener)/*-{
		...
		var changeListener = {
			centerChanged : function() {
				$entry(listener.@ol.gwt.view.StatusChangeListener::centerChanged()());
			},
			resolutionChanged : function() {
				$entry(listener.@ol.gwt.view.StatusChangeListener::resolutionChanged()());
			},
			rotationChanged : function() {
				$entry(listener.@ol.gwt.view.StatusChangeListener::rotationChanged()());
			}
		};
